...
public interface OpenDotaCache {
  ...
  void addPlayerHeroInfo(List<PlayerHeroInfo> playerHeroInfoList, int steam32Id, int patch);
  ...
  Optional<List<PlayerHeroInfo>> getPlayerHeroInfo(int steam32Id, int patch);
